...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figures/attention_map.png}
    \caption{Activation Map (Interpretability). Regions of high neural activation align precisely with textual descriptors.}
    \label{fig:attention}
\end{figure}
