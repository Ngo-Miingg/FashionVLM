...
2. **Category-Aware Hard-Negative Contrastive Loss:** A mathematical penalty applied to intra-category negative pairs (e.g., distinguishing two different black shoes) to force fine-grained visual discrimination.
...
Assuming you have downloaded the pre-trained weights to `./weights` and the dataset to `./dataset_raw`:
```bash
